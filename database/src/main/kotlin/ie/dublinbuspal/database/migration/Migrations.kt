...
object Migrations {
    ...
    val MIGRATION_1_2 = object : Migration(1, 2) {
        ...
        override fun migrate(database: SupportSQLiteDatabase) {
            ...
            database.execSQL("CREATE TABLE IF NOT EXISTS `bac_stops` (`id` TEXT NOT NULL, `name` TEXT NOT NULL, `latitude` REAL NOT NULL, `longitude` REAL NOT NULL, `routes` TEXT NOT NULL, PRIMARY KEY(`id`))")
            database.execSQL("CREATE TABLE IF NOT EXISTS `gad_stops` (`id` TEXT NOT NULL, `name` TEXT NOT NULL, `latitude` REAL NOT NULL, `longitude` REAL NOT NULL, `routes` TEXT NOT NULL, PRIMARY KEY(`id`))")
