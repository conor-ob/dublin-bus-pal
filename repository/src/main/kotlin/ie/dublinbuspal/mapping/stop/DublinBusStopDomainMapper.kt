...
class DublinBusStopDomainMapper : Mapper<DublinBusStopEntity, DublinBusGoAheadDublinStop> {

    override fun map(from: DublinBusStopEntity): DublinBusGoAheadDublinStop {
