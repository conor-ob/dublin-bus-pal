...
class RoutePersister(private val dao: DefaultRouteDao,
                     ...
                     private val domainMapper: RouteDomainMapper) : RoomPersister<RoutesResponseXml, List<DefaultRoute>, RoutesRequestXml> {

    override fun read(key: RoutesRequestXml): Observable<List<DefaultRoute>> {
